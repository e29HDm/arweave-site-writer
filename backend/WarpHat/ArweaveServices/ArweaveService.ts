...
export class ArweaveService {
    ...
    constructor(config?: ApiConfig) {
     ...
     async createWallet(jwk: JWKInterface|undefined = undefined): Promise<Wallet> {
    ...
    async addFunds(wallet: JWKInterface, winston: number = 1_000_000_000_000_000): Promise<void> {
